...
public final class SummaryPanel {
	...
	public void render(GuiGraphicsExtractor graphics, Font font, int x, int y, int width) {
		...
		graphics.text(font, Component.translatable("smarttrade.base.label"), x + 10, y + 9, 0xFFFFD36A, true);
		graphics.blit(RenderPipelines.GUI_TEXTURED, EMERALD_TEXTURE, x + 10, y + 32, 0, 0, 16, 16, 16, 16);
		graphics.text(font, Component.translatable("smarttrade.base.name"), x + 32, y + 36, 0xFFFFFFFF, true);

		int statsStart = Math.max(x + 150, x + width - 285);
		drawStat(graphics, font, statsStart, y + 18, Component.translatable("smarttrade.base.output"), "1");
		drawStat(graphics, font, statsStart + 90, y + 18, Component.translatable("smarttrade.base.limit"), "12");
		drawStat(graphics, font, statsStart + 190, y + 18, Component.translatable("smarttrade.base.experience"), "2");
	}
